...
const recommendationsData = [
  {
    category: "FOOD",
    description: "For Chicken-Fried Steak, Too Much Is Just Enough",
    url: "#",
  },
  {
    category: "CARS",
    description: "Storm Has Car Dealers Doing Swift Business",
    url: "#",
  },
  {
    category: "MOVIES",
    description: "War Is Hell? In New Military Dramas, It’s One-Dimensional",
    url: "#",
  },
  {
    category: "NFL",
    description: "11 surprising stat rankings for active NFL players",
    url: "#",
  },
  {
    category: "TECH REVIEWS",
    description: "The bookcases you can buy online and assemble yourself",
    url: "#",
  },
];
...
const compiledRecommendationTemplate = Handlebars.compile(
  recommendationTemplate
);
const recommendationsHTML = recommendationsData
  .map((rec) => compiledRecommendationTemplate(rec))
  .join("");
...
const articlesHTML = articlesData
  .map((article) => compiledArticleTemplate(article))
  .join("");
...
$(document).ready(function () {
  ...
  const avatarDavidImgSrc = require("./resources/images/David_avatar.png");
  $("#david").attr("src", avatarDavidImgSrc);

  const avatarAlexandraImgSrc = require("./resources/images/Alexandra_avatar.png");
  $("#alexandra").attr("src", avatarAlexandraImgSrc);

  const avatarOliviaImgSrc = require("./resources/images/Olivia_avatar.png");
  $("#olivia").attr("src", avatarOliviaImgSrc);
